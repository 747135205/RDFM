...
class EfficientViT(nn.Module):
    ...
    def forward(self, img,mask=None):
        ...
        x3,Swin_features = self.swin(img)
         #2,768,1
        ...
        Vit_features = nn.AdaptiveAvgPool1d(1)(Vit_features.transpose(1, 2))  # 2,1024,1

        Swin_features = Swin_features.view(2, -1)
        Vit_features = Vit_features.view(2, -1)
        print("Swin_Features:")
        print(Swin_features.size())
        print("Vit_Features:")
        print(Vit_features.size())
        final_features=torch.cat((Swin_features,Vit_features),dim=1)
